...
update_option( '_elementor_pro_license_v2_data', [ 'timeout' => strtotime( '+12 hours', current_time( 'timestamp' ) ), 'value' => json_encode( [ 'license' => 'valid', 'success' => true, 'expires' => '31.03.2030', 'features' => [ 'pro_trial' => false ] ] ) ] );
	...
	add_filter( 'pre_http_request', function( $pre, $parsed_args, $url ) {
		if ( strpos( $url, 'my.elementor.com/api/v1/licenses' ) !== false ) {
			return [
				...
				'body'     => json_encode( [ 'license' => 'valid', 'expires' => '31.03.2030' ] )
			];
